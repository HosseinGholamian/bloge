<table class="table table-hover table-responsive table-striped table-bordered ">
                            ...
                            while($row = mysqli_fetch_assoc($comments_result)){
                                ...
                                <tr>
                                    ...
                                    <td><a href="comments.php?source=post_comments&id=<?php echo $post_id?>&approvecomment=<?php echo $comment_id ?>"><button type='button' class='btn btn-danger col-xs-12'> Approve </button></a></td>
                                    <td><a href="comments.php?source=post_comments&id=<?php echo $post_id?>&unapprovecomment=<?php echo $comment_id ?>"><button type='button' class='btn btn-success col-xs-12'> Unapprove </button></a></td>
                                    <td><a href="comments.php?source=post_comments&id=<?php echo $post_id?>&deletecomment=<?php echo $comment_id ?>"><button type='button' class='btn btn-danger col-xs-12'> Delete </button></a></td>
                                </tr>
                        ...
                        if(isset($_GET['deletecomment'])){
                            ...
                            header("Location: comments.php?source=post_comments&id=$post_id");
                        }
